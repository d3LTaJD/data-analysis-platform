...
router = APIRouter()
business_service = BusinessAnalystService()
...
async def upload_file(
    ...
    try:
        ...
        analysis = Analysis(
            ...
            analysis_type="business_analyst",
...
async def analyze_data(
    ...
    result = await db.execute(
        select(Analysis).where(
            ...
            Analysis.analysis_type == "business_analyst"
        )
    )
    ...
    background_tasks.add_task(
        business_service.run_business_analysis,
        analysis_id,
        analysis.file_path,
        db
    )
...
async def download_report(
    ...
    return FileResponse(
        ...
        filename=f"business_analysis_{analysis_id}_{report_type}.{report_type}",
...
async def generate_reports(
    ...
    background_tasks.add_task(
        business_service.generate_reports,
        analysis_id,
        analysis.results,
        db
    )
