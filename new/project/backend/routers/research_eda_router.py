...
from services.research_eda_service import ResearchEDAService
...
router = APIRouter()
research_service = ResearchEDAService()
...
async def analyze_data(
    ...
    result = await db.execute(
        select(Analysis).where(
            ...
            Analysis.analysis_type == "research_eda"
        )
    )
    ...
    background_tasks.add_task(
        research_service.run_research_analysis,
        analysis_id,
        analysis.file_path,
        db
    )
    ...
    return {
        ...
        "status": "processing",
        "message": "Research & EDA analysis started in background"
    }
...
async def download_report(
    ...
    return FileResponse(
        ...
        filename=f"research_eda_{analysis_id}_{report_type}.{report_type}",
...
async def generate_reports(
    ...
    background_tasks.add_task(
        research_service.generate_reports,
        analysis_id,
        analysis.results,
        db
    )
